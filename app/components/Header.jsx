    ...
    return (
        <div id="header" className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                <a href="#contact" className='px-10 py-3 border border-gray-500 rounded-full gap-2
            flex items-center'> Contact Me
                    <Image src={assets.right_arrow_bold} alt='Contact Me' className='w-4 dark:invert' />
                </a>
                <a href="/Nolan_Tuttle_Resume.pdf" download="Nolan_Tuttle_Resume.pdf"
                    className='px-10 py-3 border rounded-full border-gray-500 
            flex items-center gap-2'> My Resume
                    <Image src={assets.download_icon} alt='Resume Download' className='w-4 dark:invert' />
                </a>
            </div>
